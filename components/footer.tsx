      ...
      <div className="max-w-7xl mx-auto">
        <div className="container mx-auto px-6">
          {locations.map((location, locationIndex) => (
            <div key={locationIndex} className="pb-12 mb-8">
              <div className="divider divider-primary uppercase text-lg font-semibold">
                {location.name}
              </div>
        ...
        <div className="container mx-auto mt-12 pt-8 border-t border-neutral-700 px-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-neutral-400">
            <p className="text-base">
              © {new Date().getFullYear()} Ordinacija Božić. Vse pravice pridržane.
            </p>
