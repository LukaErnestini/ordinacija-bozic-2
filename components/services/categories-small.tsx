          ...
          {data?.serviceCategoryConnection.edges?.map((categoryData) => {
            ...
            return (
              <Link
                ...
                key={category?.id}
                className="group relative h-72 overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
              >
                {/* Background Pattern */}
