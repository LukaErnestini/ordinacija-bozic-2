    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-serif font-bold text-gray-800 mb-4">Obvestila</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Spremljajte pomembne informacije o delovnem času, posebnih storitvah in novostih v naši ordinaciji.
          </p>
        </div>
